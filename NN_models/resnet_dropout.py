...
"""Forked from 
https://github.com/google/uncertainty-baselines/blob/main/uncertainty_baselines/models/resnet50_dropout_torch.py"""
...
def _resnet_dropout(block: Type[Union[BasicBlock,
                    ...
                    dropout_rate: float, **kwargs: Any) -> ResNetDropout:
  model = ResNetDropout(block, layers, dropout_rate, **kwargs)
  return model
